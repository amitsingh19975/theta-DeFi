...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield resolver.addRow({ input: { name: 'A1', phone: 123123, salary: 123.3, city: 'Lucknow', country: 'India' } });
    console.log(file.approxSize);
    yield resolver.addRow({ input: { name: 'A2', phone: 123123, salary: 123.2, city: 'Lucknow', country: 'India' } });
    console.log(file.approxSize);
    yield resolver.addRow({ input: { name: 'A3', phone: 123123, salary: 123.2, city: 'Lucknow', country: 'India' } });
    console.log(file.approxSize);
    yield resolver.addRow({ input: { name: 'A4', phone: 123123, salary: 123.2, city: 'Lucknow', country: 'India' } });
    console.log(file.approxSize);
    yield resolver.addRow({ input: { name: 'A5', phone: 123123, salary: 123.2, city: 'Lucknow', country: 'India' } });
    console.log(file.approxSize);
    // await resolver.commit();
    yield resolver.addRow({ input: { name: 'A6', phone: 123123, salary: 123.2, city: 'Lucknow', country: 'India' } });
    yield resolver.addRow({ input: { name: 'A7', phone: 123123, salary: 123.2, city: 'Lucknow', country: 'India' } });
    yield resolver.addRow({ input: { name: 'A8', phone: 123123, salary: 123.2, city: 'Lucknow', country: 'India' } });
    yield resolver.addRow({ input: { name: 'A9', phone: 123123, salary: 123.2, city: 'Lucknow', country: 'India' } });
    yield resolver.addRow({ input: { name: 'A10', phone: 123123, salary: 123.2, city: 'Lucknow', country: 'India' } });
    yield resolver.addRows({ input: [
    ...
    (0, graphql_1.graphql)({ schema: file.makeGraphQLSchema(), source: '{show{name}}', rootValue: resolver })
        .then(res => { var _a; return console.log(util_1.default.inspect((_a = res.data) === null || _a === void 0 ? void 0 : _a.show, { showHidden: false, depth: null, colors: true })); });
    // await resolver.commit();
