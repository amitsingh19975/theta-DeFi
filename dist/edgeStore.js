...
exports.market = exports.MarketMethod = exports.getFile = exports.putFile = exports.getData = exports.putData = exports.getPeers = exports.getStatus = exports.getVersion = exports.validateAddress = exports.validateRow = exports.initializeEdgeStore = exports.MAX_BLOCK_SIZE = void 0;
...
const initializeEdgeStore = (config) => {
    var _a, _b;
    EdgeStoreConfig.domain = (config === null || config === void 0 ? void 0 : config.domain) || EdgeStoreConfig.domain;
    EdgeStoreConfig.port = (config === null || config === void 0 ? void 0 : config.port) || EdgeStoreConfig.port;
    EdgeStoreConfig.protocol = (config === null || config === void 0 ? void 0 : config.protocol) || EdgeStoreConfig.protocol;
    EdgeStoreConfig.market = {
        domain: ((_a = config === null || config === void 0 ? void 0 : config.market) === null || _a === void 0 ? void 0 : _a.domain) || EdgeStoreConfig.market.domain,
        port: ((_b = config === null || config === void 0 ? void 0 : config.market) === null || _b === void 0 ? void 0 : _b.port) || EdgeStoreConfig.market.port
    };
};
